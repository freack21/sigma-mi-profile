...
@section('article_body')
  ...
  <img src="{{ asset('services/img/penahapan-sertifikasi-halal.png') }}" alt="Pelaksanaan Sertifikasi Halal">

  <h4>
    9. Alur Proses Pelaksanaan Halal
  </h4>
  <img src="{{ asset('services/img/proses-pelaksanaan-halal.png') }}" alt="Alur Proses Pelaksanaan Halal">

  <h4>
    10. Penetapan Tarif
  </h4>
  <img src="{{ asset('services/img/penetapan-tarif-halal.png') }}" alt="Penetapan Tarif">
  ...
  <p>
    Bagi pelanggan yang ingin mendapatkan pelayanan sertifikasi halal, dapt melakukan pengisian pendaftaran formulir sertifikasi halal, dengan formulir dibawah ini: <a href="{{ asset('services/docs/Form Pendaftaran Halal.docx') }}" class="link">Unduh file (.doc)</a>
  </p>
